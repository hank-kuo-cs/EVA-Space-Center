...
class CosSimiSphericalLoss(torch.nn.Module):
    ...
    def forward(self, outputs, targets):
        ...
        print("c_o: {}, {}".format(unit_camera_cas_outputs, outputs_camera_scalar))
        print("p_o: {}, {}".format(unit_optic_cas_outputs, outputs_optic_scalar))
        print("u_o: {}, {}".format(unit_u_cas_outputs, outputs_u_scalar))
        print("c_t: {}, {}".format(unit_camera_cas_targets, targets_camera_scalar))
        print("p_t: {}, {}".format(unit_optic_cas_targets, targets_optic_scalar))
        print("u_t: {}, {}".format(unit_u_cas_targets, targets_u_scalar))
